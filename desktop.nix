...
let
  ...
  workspaceKeys = lib.listToAttrs (lib.concatMap (n: [
    { name = "xfwm4/custom/<Super>${toString n}"; value = "workspace_${toString n}_key"; }
    { name = "xfwm4/custom/<Super><Shift>${toString n}"; value = "move_window_workspace_${toString n}_key"; }
  ]) [ 1 2 3 4 5 ]);
in {
  ...
  environment.systemPackages = with pkgs; [
    alacritty rofi xfce4-screenshooter xfce4-whiskermenu-plugin
    xfce4-pulseaudio-plugin pavucontrol gnome-themes-extra elementary-xfce-icon-theme
    zenLauncher codexLauncher terminalLauncher filesLauncher
  ];
  ...
  home-manager.users.${settings.username} = {
    ...
    programs.alacritty = {
      ...
      settings = {
        ...
        colors.primary = { background = "#1e1e1e"; foreground = "#deddda"; };
      };
    };
    ...
    xfconf.settings = {
      ...
      xfwm4 = {
        ...
        "general/workspace_names" = [ "1" "2" "3" "4" "5" ];
      ...
      xfce4-keyboard-shortcuts = {
        ...
        "commands/custom/XF86AudioRaiseVolume" = "${pkgs.wireplumber}/bin/wpctl set-volume -l 1 @DEFAULT_AUDIO_SINK@ 5%+";
        "commands/custom/XF86AudioLowerVolume" = "${pkgs.wireplumber}/bin/wpctl set-volume @DEFAULT_AUDIO_SINK@ 5%-";
        "commands/custom/XF86AudioMute" = "${pkgs.wireplumber}/bin/wpctl set-mute @DEFAULT_AUDIO_SINK@ toggle";
        "commands/custom/XF86AudioMicMute" = "${pkgs.wireplumber}/bin/wpctl set-mute @DEFAULT_AUDIO_SOURCE@ toggle";
      ...
      xfce4-panel = {
        ...
        "panels/panel-1/size" = uint 34;
        "panels/panel-1/icon-size" = uint 24;
        ...
        "plugins/plugin-6/items" = [ "${terminalLauncher}/share/applications/workstation-terminal.desktop" ];
